...
<html>
    <head>
        <title>Redeem a gift</title>
        <meta charset="UTF-8">
        <link rel="icon" href="../assets/logo.png"/>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link href="https://fonts.googleapis.com/css?family=Noto+Sans&display=swap" rel="stylesheet"> 
        <link href="https://fonts.googleapis.com/css?family=Barlow&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="../responsive_stylesheet/redeem.css"/>
        <meta name="description" content="Enter your redemption code into the claim box and then complete
                    the redemption process by creating an account, entering your shipping
                    address, and checking out to confirm your order is completed"/>
        <meta name="robots" content="index,follow"/>
        <meta name="DC.title" content="Claim Your Motor Crate Gift Box"/>
    </head>
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="redeem">
                <h1>Redeem your Motor Crate Gift Box</h1>
                <div class="box">
                    <h2>Claim Your Motor Crate Gift Box</h2>
                    <p>Enter your redemption code into the claim box and then complete
                    the redemption process by creating an account, entering your shipping
                    address, and checking out to confirm your order is completed.</p>
                    <p><input type="password" id="code" /> </p>
                    
                    <div id="result"></div>
                    <button onclick="redeemer();">Redeem</button>
                </div>
            </div>
            <div id="footer">
                <div class="foot">
