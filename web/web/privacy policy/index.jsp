...
<%
    ...
    ResultSet rs = jdbc.query(stmt, "select privacy,email,facebook,twitter,instagram from editor");
    ...
    if(rs.next()){
        ...
        privacy = UrlEntities.decode(rs.getString("privacy"));
    }
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../responsive_stylesheet/privacy.css"/>
        <meta name="description" content="Your privacy is important to us and always have been. 
              So we've have developed a Privacy Policy that covers how we collect, 
              use, disclose, transfer and store your information.Please take a moment 
              to familiarize yourself with our privacy practices and let us know if 
              you have any questions."/>
        <meta name="robots" content="index,follow"/>
        <meta name="DC.title" content="motor crate gift box privacy policy"/>
    </head>
    <body>
        <div id="wrapper">
            <div id="header">
            ...
            <div id="privacy">
                ...
                <p class="topparagraph">
                    Your privacy is important to us and always have been. So we've have developed a Privacy Policy
                    that covers how we collect, use, disclose, transfer and store your information.Please take a
                    moment to familiarize yourself with our privacy practices and let us know if you have any 
                    questions.
                </p>
                <p class="midparagraph">
                    By visiting Motor Crate Gift Box, you are accepting the practices described in this Privacy Notice.
                </p>
                <%=privacy.isEmpty() ? "" :privacy%>
                <div class="bottom">
