...
<html>
    <head>
        ...
        <meta name="description" content="Motor crate gift box sign in page"/>
        <meta name="robots" content="index,follow"/>
        <meta name="DC.title" content="Motor crate gift box sign in page"/>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="form">
                <h1>WELCOME BACK</h1>
                <p class="p1">New to Motor Crate?</p>
                <p class="p2"><a href="../sign up/">Join Today</a></p>
                <div class="box">
                    ...
                    <nav class="bottomNav">
                        ...
                        <input type="password"  class="pass" name="password" id="password"/>
                    </nav>
                    <p id="result"></p>
