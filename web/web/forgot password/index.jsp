    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="forgot">
                ...
                <p class="firstp">Forgot your password?</p>
                <p class="secondp" id="result">Enter your Email and we will help you reset your password</p>
                <p class="thirdp"><input type="text" placeholder="Email" id="email"/></p>
                <button onclick="forgot();">Reset</button>
            </div>
            <div id="footer">
                <div class="foot">
                    <div class="footlet">
