...
<%
   ...
   if(session.getAttribute("billing").toString() != null){
       billing  = (Billing)session.getAttribute("billing");
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../responsive_stylesheet/successful.css"/>
        <meta name="description" content="payment confirmation page"/>
        <meta name="robots" content="index,follow"/>
        <meta name="DC.title" content="payment confirmation page"/>
    </head>
    <body>
        <div id="wrapper">
            <div id="header">
            ...
            <div id="payment">
                <nav><img src="../assets/payment1.png"/> <span>Payment Successful</span></nav>
                <h3><%=billing.getCategory().isEmpty() ? "" :billing.getCategory()%></h3>
                <img src="../assets/payment2.png" class="img2"/>
                <p class="p3"><%=billing.getDuration().isEmpty() ? "" :billing.getDuration() %>
                    will renew on <%=billing.getDueDate().isEmpty() ? "" :billing.getDueDate() %>
                    . pause/cancel anytime</p>
                <p class="p4"><a href="../plan/">change my box</a></p>
                
                <h4>Your first box ships next business day</h4>
