...
<html>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="payment">
                <nav><img src="../assets/payment1.png"/> <span>Payment Failed</span></nav>
                <h3><%=billing.getCategory().isEmpty() ? "" :billing.getCategory()%></h3>
                <img src="../assets/payment2.png" class="img2"/>
                <p class="p3">oops! sorry unknown error occured, please try again later</p>
                <p class="p4"><a href="../plan/">change my box</a></p>
                
                <h4>Motor crate Gift Box always at your service</h4>
